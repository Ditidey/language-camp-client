...
const About = () => {
    return (
        <div className='md:relative px-20 py-10 bg-purple-50 h-[650px] '>
             <img className='h-[600px] ' src="https://media.istockphoto.com/id/1297624591/photo/smiling-female-teacher-writing-at-whiteboard-explaining-rules.webp?b=1&s=170667a&w=0&k=20&c=1DgovZC5nWYpfF6wRTyZWQmf6uMtPWa891KZ7Nw8lwk=" alt="" />
